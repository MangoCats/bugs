...
#define POP_TARGET    ( ( WORLD_X * WORLD_Y ) / 20 )
#define POP_HARDLIMIT ( ( WORLD_X * WORLD_Y ) / 3 )
...
//      if ( today == 294912 ) interval = 1024;  // Begin year 9
      ...
      if ( wait > 0 )
        ...
        { if (( stage == 0 ) && (buglist.n_bugs > 1000)) { foodhump = 3.0; stage = 1; wait =   0; }
